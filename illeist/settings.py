# Django settings for illeist project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Sean McLean', 'smclean@gmail.com'),
)
...
SECRET_KEY = 'aas550b4oky)n@9(57_vk$clpp0y+i*mciex=ji+2v1)r-&amp;wxi'
...
ROOT_URLCONF = 'illeist.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'illeist.wsgi.application'
...
INSTALLED_APPS = (
    ...
    # non-enabled-by-default contrib
